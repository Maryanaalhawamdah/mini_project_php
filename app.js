...
//last name field
let familynametName=document.getElementById("familyName");
familynametName.addEventListener("focus",function(){
    document.getElementById("familyName").style.display="block";
})
familynametName.addEventListener("blur",function(){
    document.getElementById("familyName").style.display="none";
})
familynametName.addEventListener("keyup",function(){
    let lNameRE=/[a-zA-Z]{3,}/g;
    if(familynametName.value.match(lNameRE)==lastName.value){
...
mobile.addEventListener("keyup",function(){
    let mobileRE=/[0-9]{14}/;
    if(familynametName.value.match(mobileRERE)==mobile.value){
